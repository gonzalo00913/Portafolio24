  ...
  return (
    <div className={style.containerAll}>
      ...
      <section className={style.containerProyects}>
        ...
        <div className={style.projects}>
          <a href="https://food-app-gonzalo-masa.netlify.app/" target="_blanck">
          <h4>Food App</h4>
          </a>
          <p className={style.desProjects}>
            {" "}
        ...
        <div className={style.projects}>
        <a href="https://gonzalo00913.github.io/Project--Three-Project-Calculator/" target="_blanck">
          <h4>Calculator</h4>
          </a>
          <p className={style.desProjects}>
        ...
        <div className={style.projects}>
        <a href="https://gonzalo00913.github.io/Project-Rock-Paper-Scissors/" target="_blanck">
        ...
        <div className={style.projects}>
        <a href="https://gonzalo00913.github.io/Etch-A-Sketch/" target="_blanck">
          <h4>Etch-A-Sketch</h4>
          </a>
          <p className={style.desProjects}>
